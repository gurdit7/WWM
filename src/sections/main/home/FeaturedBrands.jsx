  ...
  <div className="border border-[#F4F2F0] border-solid rounded-[10px]">
    ...
    <div className="flex flex-col pt-[6px] pb-3 px-3">
      {brand.products.map((product, index) => (
        <div
          className="flex justify-center md:justify-between py-[8.5px] px-[12px] relative items-center hover:bg-[#F8F8F7] rounded-[6px] transition duration-500"
          key={index}
        >
          <Text className="text-[14px] lg:text-[17px]  leading-[23.15px] font-normal text-[#000]">
            {product.productName}
          </Text>
          <Text className="!text-[12px] !leading-[16.8px] hidden md:block text-dark-100 !font-semibold rounded-[6px] border border-light-50 py-[1px] px-[6px]">
